...
from net.model.cdiscount.dualpathnet92  import image_to_tensor_transform, DPNet92 as Net
...
def run_train():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/dpn92-180-05a' # s_xx1'
    initial_checkpoint = \
        '/root/share/project/kaggle/cdiscount/results/dpn92-180-05/checkpoint/00016500_model.pth'

    pretrained_file = \
        None #'/root/share/project/kaggle/cdiscount/model/dpnet92/mihas/dpn92-0066.pth'
    ...
    ## optimiser ----------------------------------
    iter_accum  = 2
    batch_size  = 640//iter_accum #256//288 #512 #2*288//iter_accum
    ...
    if 0: ##<debug>
        for n in iter(train_dataset):
            image, label, index = train_dataset[n]
