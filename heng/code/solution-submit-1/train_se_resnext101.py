...
from net.model.cdiscount.se_resnext_101_32x4d  import image_to_tensor_transform, SEResnext101 as Net
...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/se-resnext101-51c' # s_xx1'
    initial_checkpoint = \
        '/root/share/project/kaggle/cdiscount/results/se-resnext101-51b/checkpoint/00180500_model.pth'
       #'/root/share/project/kaggle/cdiscount/results/resnet-101-50/checkpoint/00003000_model.pth'

    pretrained_file = \
        None #'/root/share/project/kaggle/cdiscount/model/se-resnext101-180-03b/checkpoint/00121000_model.pth'
    ...
    ## optimiser ----------------------------------
    iter_accum  = 2
    batch_size  = 512//iter_accum #256//288 #512 #2*288//iter_accum  640
