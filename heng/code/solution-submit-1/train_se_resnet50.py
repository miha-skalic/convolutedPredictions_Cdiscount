...
def run_training():
    ...
    out_dir = '/root/share/project/kaggle/cdiscount/results/results/excited-resnet50-180-00a'
    initial_checkpoint = \
        None
        #  '/home/ck/project/results/resnet101-160-07/checkpoint/00010000_model.pth'
