...
from net.model.cdiscount.xception  import image_to_tensor_transform, Xception as Net
...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/xcpetion-20b' # s_xx1'
    initial_checkpoint = \
       '/root/share/project/kaggle/cdiscount/results/xcpetion-20a/checkpoint/00367500_model.pth'
       #'/root/share/project/kaggle/cdiscount/model/xception-180-01b/checkpoint/00158000_model.pth'
