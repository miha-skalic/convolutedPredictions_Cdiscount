...
model_name = "inceptionv3_v0_wider12k_SELU_cp100_dropout03"
...
read_file = glob('../tf_preprocessing/C_inceptionv3_v3_cp98_train_2layer/record_*.tfrecords')
read_file_val = glob('../tf_preprocessing/C_inceptionv3_v3_cp98_val1_2layer/record*.tfrecords')

model = Sequential()
model.add(Dense(12000, input_shape=(4, 2048), activation='selu', kernel_initializer='lecun_normal'))
...
my_queue = queue_gen(read_files=read_file, batch_size=512, epochs=2000, feat_name="inceptionv3")
my_val_queue = queue_gen(read_files=read_file_val, batch_size=512, epochs=2000, feat_name="inceptionv3")
