...
fp = np.memmap("/shared/miha/ws/competitions/p18french/ensemble/mem_maps/mihas_3model_c100_width10k_DO03_wflip.memmap",
...
next(my_queue)
model1 = get_selu_maxpool(10000)
model1.load_weights(
    "/workspace6/mihaDL_stuff/models/xception_v0_wider10k_SELU_cp100_dropout03/xception_v0_wider10k_SELU_cp100_dropout03_800.hdf5")

model3 = get_selu_maxpool(10000, indims=1536)
model3.load_weights(
    "/workspace6/mihaDL_stuff/models/inceptionresnet_v0_wider10k_SELU_cp100_dropout03/inceptionresnet_v0_wider10k_SELU_cp100_dropout03_800.hdf5")

model5 = get_selu_maxpool(10000)
model5.load_weights(
    "/workspace6/mihaDL_stuff/models/inceptionv3_v0_wider10k_SELU_cp100_dropout03/inceptionv3_v0_wider10k_SELU_cp100_dropout03_800.hdf5")
