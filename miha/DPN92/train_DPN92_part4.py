...
num_classes = 5270
sym, arg_params, aux_params = mx.model.load_checkpoint("./trained_models/DPN92_tSGD", 41)
...
mod.fit(train_gen, val_gen,
        ...
        epoch_end_callback=mx.callback.do_checkpoint("trained_models/DPN92_tSGD_part4"),
        optimizer='sgd',
