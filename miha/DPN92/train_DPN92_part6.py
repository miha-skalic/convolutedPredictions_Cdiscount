...
num_classes = 5270
sym, arg_params, aux_params = mx.model.load_checkpoint("./trained_models/DPN92_tSGD_170", 57)
...
# sym = mx.symbol.Flatten(mx.symbol.Pooling(data=sym, pool_type='avg', kernel=(6,6), stride=(1,1), pad=(0,0), name='avg_pool'))
...
mod.fit(train_gen, val_gen,
        ...
        optimizer_params={'learning_rate': 0.0008},
